...
const ProductDetails = () => {
    ...
    const fetchSingleProduct = async () => {
        try {
            let res = await axios.get(`http://localhost:5000/api/product/single/${id}`);
                                ...
                                <div className="w-full">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-2">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <svg
                                                    className="w-3.5 h-3.5 fill-[##DB4444]"
                                                    viewBox="0 0 14 13"
                                                    fill="none"
                                        ...
                                        <div className="flex items-center flex-wrap gap-2 mt-6">
                                            ...
                                            <h4 className="text-[#DB4444] text-2xl sm:text-3xl font-semibold">
                                                ${product.sellingPrice}
                                            </h4>
                                            <div className="flex py-1 px-2 bg-[#DB4444] font-semibold !ml-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4 flex flex-wrap gap-4">
                                            <button
                                                type="button"
                                                className="px-4 py-3 w-[45%] cursor-pointer border border-[#DB4444] hover:bg-[#DB4444] duration-300 hover:text-[#ffffff] text-slate-900 text-sm font-medium"
                                            >
                                                Add to cart
                                            </button>
                                            <button
                                                type="button"
                                                className="px-4 py-3 w-[45%] cursor-pointer border border-[#DB4444] bg-[#DB4444] hover:bg-transparent hover:text-[#DB4444] duration-300 text-white text-sm font-medium"
                                            >
                                                Buy it now
                                            </button>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-6 max-w-sm">
                                            ...
                                            <button
                                                type="button"
                                                className="border border-[#DB4444] outline-0 bg-[#DB4444] hover:bg-transparent hover:text-[#DB4444] duration-300 text-white cursor-pointer px-4 py-2.5 text-sm"
                                            >
                                                Apply
                                            </button>
                                        </div>
                                    ...
                                    <div className="flex justify-between gap-4 mt-8">
                                        <div className="text-center">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="w-8 h-8 fill-[#DB4444] cursor-pointer inline"
                                                viewBox="0 0 64 64"
                                            >
                                                <g data-name="Layer 2">
                                                    <path
